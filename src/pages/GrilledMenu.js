        ...
        <Grid item xs={3}>
          <Paper className="MenuGrilledGrid">
            ...
            <ul dir="rtl" className="ulTableGrilledPrice">
              ...
              <li>
                <div className="priceTableGrilled">
                  ...
                  <span className="spanGrilledDetails">
                    ...
                    או מרובע, כסאות עץ או פלסטיק, כיסוי מהודר לכיסאות, שמשוניות,
                    מחיצות, מזגנים ניידים, אוהלים, פתרונות הצללה, סידור בלונים,
                    סידור פרחים, כורסאות ישיבה פופים , שנדלירים תאורה וכל מה
                    שעושה לכם טוב בארוע שלכם
                  </span>
                </div>
              </li>
              ...
              <li>
                <div className="priceTableGrilled">
                  <span className="spanGrilledDetails">הובלה בתוספת תשלום</span>
                </div>
              </li>
            </ul>
